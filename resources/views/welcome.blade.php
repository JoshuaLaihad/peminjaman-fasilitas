...
<head>
  ...
  <title>Aplikasi Peminjaman Fasilitas Kampus</title>
...
<body class="index-page">
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
            <h1>Aplikasi Peminjaman Fasilitas Kampus</h1>
            <p>Selamat Datang di Website Peminjaman Fasilitas Kampus Politeknik Negeri Bengkalis</p>
            <div class="d-flex">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
            <p>
              Aplikasi ini dibuat atas rancangan Tugas Akhir Joshua Onesimus Samuel Rich Laihad mahasiswa D3 Teknik Informatika sebagai syarat kelulusan Sidang Tugas Akhir.
            </p>
          </div>
    ...
    <section id="services" class="services section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Services</h2>
        <p>Hal yang dapat dilakukan pada website ini.</p>
      </div><!-- End Section Title -->
